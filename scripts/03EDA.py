...
# Read in data
pDF1 = pd.read_csv(dataPath) # 718220 x 9 
...
maxCREAT['outcome2.condition1'] = maxCREAT.creatinine >= (1+0.5)*maxCREAT.creat_atADMISSION
maxCREAT['outcome2.condition2'] = (maxCREAT.time - maxCREAT.admission) <= pd.Timedelta("52hours")
maxCREAT['outcome2'] = np.logical_and(maxCREAT['outcome2.condition1'], maxCREAT['outcome2.condition2'])

# hi
# hello
# fundamentals ~ noninferiority design; 
# we might have been wrong in using the WRONG terminology.
# Exposure / outcome framework VS prediction ground truth framework
# (I changed it up; we should discuss this a lot though)
# Aim 1: correlation ~ test/GT 
# Aim 2: not inferior ; 
# What Qs do I not answer:
# GOOD man
